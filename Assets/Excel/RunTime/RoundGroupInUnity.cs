...
/// 
[System.Serializable]
public class RoundGroupInUnity : ScriptableObject 
{	
    ...
    public RoundGroupInUnityData[] dataArray;
    public List<RoundGroupInUnityData> dataList;
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new RoundGroupInUnityData[0];
