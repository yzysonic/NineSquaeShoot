...
/// 
[System.Serializable]
public class CharacterDataInUnity : ScriptableObject 
{	
    ...
    public CharacterDataInUnityData[] dataArray;
    public List<CharacterDataInUnityData> dataList;
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new CharacterDataInUnityData[0];
