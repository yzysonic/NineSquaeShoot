...
/// 
[System.Serializable]
public class SoundDataInUnity : ScriptableObject 
{	
    ...
    public SoundDataInUnityData[] dataArray;
    public List<SoundDataInUnityData> dataList;
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new SoundDataInUnityData[0];
