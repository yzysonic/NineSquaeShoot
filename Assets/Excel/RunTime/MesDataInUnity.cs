...
/// 
[System.Serializable]
public class MesDataInUnity : ScriptableObject 
{	
    ...
    public MesDataInUnityData[] dataArray;
    public List<MesDataInUnityData> dataList;
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new MesDataInUnityData[0];
