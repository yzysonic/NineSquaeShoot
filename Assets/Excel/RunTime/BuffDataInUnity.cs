...
/// 
[System.Serializable]
public class BuffDataInUnity : ScriptableObject 
{	
    ...
    public BuffDataInUnityData[] dataArray;
    public List<BuffDataInUnityData> dataList;
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new BuffDataInUnityData[0];
