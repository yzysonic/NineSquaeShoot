...
/// 
[System.Serializable]
public class SkillDataInUnity : ScriptableObject 
{	
    ...
    public SkillDataInUnityData[] dataArray;
    public List<SkillDataInUnityData> dataList;
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new SkillDataInUnityData[0];
