...
/// 
[System.Serializable]
public class StageDataInUnity : ScriptableObject 
{	
    ...
    public StageDataInUnityData[] dataArray;
    public List<StageDataInUnityData> dataList;
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new StageDataInUnityData[0];
