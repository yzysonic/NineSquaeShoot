...
/// 
[System.Serializable]
public class ProjecttileDataInUnity : ScriptableObject 
{	
    ...
    public ProjecttileDataInUnityData[] dataArray;
    public List<ProjecttileDataInUnityData> dataList;
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new ProjecttileDataInUnityData[0];
